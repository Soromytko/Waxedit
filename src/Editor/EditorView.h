...
#include "../defines.h"
#include "../View/CodeEditorWidget.h
...
private:
	rendell_ui::TextWidgetSharedPtr createTextEdit(rendell_ui::WidgetWeakPtr parent, const std::wstring& text) const;

	EditorPresenterSharedPtr _presenter;
	EditorCanvasSharedPtr _canvas;
	rendell_ui::RectangleWidgetSharedPtr _rootWidget;

	std::unordered_map<std::wstring, rendell_ui::TextWidgetSharedPtr> _documents;
};
