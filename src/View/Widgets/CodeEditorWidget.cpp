...
CodeEditorWidget::CodeEditorWidget()
{
	...
	_textChangedConnectionId = _textEditorWidget->textChanged.connect(this, &CodeEditorWidget::onTextChanged);
	_scrollProgressChangedConnectionId = _textEditorWidget->scrollProgressChanged.connect(this, &CodeEditorWidget::onScrollProgressChanged);
